# Contributing to WaveLink.Client
...
```bash
dotnet restore WaveLink.Client.slnx
dotnet build WaveLink.Client.slnx
dotnet test WaveLink.Client.slnx
```
...
```bash
dotnet test WaveLink.Client.slnx --filter "TestCategory!=Integration"
```
