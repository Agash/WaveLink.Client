...
public sealed record SetInputDeviceParams
{
    ...
    public required List<SetInputParams> Inputs { get; set; }
...
public sealed record SetOutputDeviceParams
{
    ...
    public OutputDeviceUpdate? OutputDevice { get; set; }
...
public sealed record OutputDeviceUpdate
{
    ...
    public required List<OutputUpdate> Outputs { get; init; }
}
...
public sealed record SetChannelParams
{
    ...
    public List<ChannelMixUpdate>? Mixes { get; set; }
