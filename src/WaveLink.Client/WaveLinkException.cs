...
public class WaveLinkException : Exception
{
    ...
    public WaveLinkException(string message)
        : base(message) { }
    ...
    public WaveLinkException(string message, Exception inner)
        : base(message, inner) { }
}
...
public sealed class WaveLinkRpcException(int code, string message, object? data = null)
    : WaveLinkException(message)
{
