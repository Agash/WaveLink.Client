...
public sealed record ApplicationInfo
{
    ...
    public required int InterfaceRevision { get; set; }
...
public sealed record InputDevicesResult
{
    ...
    public required List<InputDevice> InputDevices { get; set; }
...
public sealed record InputDevice
{
    ...
    [JsonPropertyName("isWaveDevice")]
    public bool? IsWaveDevice { get; set; }
...
public sealed record Input
{
    ...
    [JsonPropertyName("micPcMix")]
    public MicPcMix? MicPcMix { get; set; }
    ...
    [JsonPropertyName("dspEffects")]
    public List<Effect>? DspEffects { get; set; }
...
public sealed record OutputDevicesResult
{
    ...
    [JsonPropertyName("mainOutput")]
    public required MainOutput MainOutput { get; set; }

    /// <summary>List of output devices.</summary>
    [JsonPropertyName("outputDevices")]
    public required List<OutputDevice> OutputDevices { get; set; }
...
public sealed record MainOutput
{
    ...
    public required string OutputDeviceId { get; set; }
...
public sealed record OutputDevice
{
    ...
    public required List<Output> Outputs { get; set; }
...
public sealed record ChannelImage
{
    ...
    [JsonPropertyName("isAppIcon")]
    public bool? IsAppIcon { get; init; }
...
public sealed record Channel
{
    ...
    public List<AppRef>? Apps { get; set; }
...
public sealed record ChannelMix
{
    ...
    public required string MixId { get; set; }
...
public sealed record MixesResult
{
    ...
    [JsonPropertyName("mixes")]
    public required List<Mix> Mixes { get; set; }
...
public sealed record FocusedAppChangedParams
{
    ...
    public FocusedAppChannel? Channel { get; set; }
...
public sealed record LevelMeterChangedParams
{
    ...
    [JsonPropertyName("inputDevices")]
    public List<MeterEntry>? InputDevices { get; set; }

    /// <summary>Level meter entries for output devices.</summary>
    [JsonPropertyName("outputDevices")]
    public List<MeterEntry>? OutputDevices { get; set; }

    /// <summary>Level meter entries for channels.</summary>
    [JsonPropertyName("channels")]
    public List<MeterEntry>? Channels { get; set; }

    /// <summary>Level meter entries for mixes.</summary>
    [JsonPropertyName("mixes")]
    public List<MeterEntry>? Mixes { get; set; }
...
public sealed record MeterEntry
{
    ...
    [JsonPropertyName("levelLeftPercentage")]
    public double? LevelLeftPercentage { get; set; }

    /// <summary>The right channel level as a percentage (0-100).</summary>
    [JsonPropertyName("levelRightPercentage")]
    public double? LevelRightPercentage { get; set; }
